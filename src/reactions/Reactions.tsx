...
export function Reactions({
  ...
  return (
    <div className="fixed top-0 left-0 h-[100dvh] w-screen pointer-events-none">
      {/* 20px is the maximum x bounce of emojis, 1em at text-size-12 is the width of the emoji */}
      <div className="absolute text-size-12 left-20px h-full w-[calc(100vw_-_40px_-_1em)] max-h-full">
        {/* <div className="absolute left-20px h-full w-200px max-h-full"> */}
